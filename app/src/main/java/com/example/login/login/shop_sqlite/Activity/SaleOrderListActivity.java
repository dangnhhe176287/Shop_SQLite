...
public class SaleOrderListActivity extends AppCompatActivity implements OrderAdapter.OnItemActionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCreateNewOrder.setOnClickListener(v -> {
            Intent intent = new Intent(SaleOrderListActivity.this, CreateOrderActivity.class);
    ...
    public void onEditClick(int orderId) {
        ...
        Intent intent = new Intent(SaleOrderListActivity.this, UpdateOrderActivity.class);
