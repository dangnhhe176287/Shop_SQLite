...
public class SaleProductResponseDto {
    ...
    public SaleProductResponseDto(int productId, String name, String description, Integer productCategoryId, String brand, double basePrice,
                                  String availableAttributes, Integer status, boolean isDelete,
                                  String createdAtStr, String updatedAtStr,
                                  List<SaleProductImageDto> productImages, List<SaleProductVariantDto> variants) {
