...
public class CategoryAdapter extends ArrayAdapter<ProductCategoryResponseDto> {
    ...
    public CategoryAdapter(@NonNull Context context, List<ProductCategoryResponseDto> categories, OnCategoryActionListener listener) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ProductCategoryResponseDto currentCategory = categories.get(position);
